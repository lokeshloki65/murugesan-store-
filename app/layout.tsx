...
export const metadata: Metadata = {
  title: "Murugesan Store - Professional Billing System",
  description:
    "Modern real-time billing system for Murugesan Store with barcode scanning, inventory management, and analytics",
  generator: "v0.app",
}
